...
function OnboardingFlow({ pal, onComplete }) {
  ...
  const STEPS = ["Welcome","Your Children","Learning Style","Curriculum","Schedule","Goals","Life & Extras"];
  ...
  return (
    <div style={{minHeight:"100vh",background:pal.sand,display:"flex",flexDirection:"column"}}>
      ...
      <div style={{flex:1,overflowY:"auto"}}>
        ...
        {step===4 && <OnbSchedule     pal={pal} data={data} upd={upd} onNext={()=>setStep(5)} />}
        {step===5 && <OnbGoals        pal={pal} data={data} upd={upd} onNext={()=>setStep(6)} />}
        {step===6 && <OnbExtras       pal={pal} data={data} upd={upd} onNext={()=>onComplete(data)} />}
      </div>
    </div>
  );
}

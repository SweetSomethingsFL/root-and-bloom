        ...
        <div style={{flex:1,overflowY:"auto",padding:"0.9rem 1.2rem 0.5rem"}}>
          ...
          {(aiNarrative||aiNarrativeLoading||aiNarrativeError)&&(
            <div style={{marginBottom:"1rem",background:pal.pale,borderRadius:"13px",padding:"0.85rem 1rem",border:"1.5px solid "+pal.primary+"30"}}>
              ...
              {aiNarrativeLoading&&(
                <div style={{fontSize:"0.78rem",color:pal.slate,fontStyle:"italic"}}>{"Crafting your narrative\u2026"}</div>
              )}
              {aiNarrativeError&&(
                <div style={{fontSize:"0.78rem",color:"#cc2222"}}>{aiNarrativeError}</div>
              )}
              {aiNarrative&&(
                <div style={{fontSize:"0.82rem",color:pal.ink,lineHeight:1.7}}>{aiNarrative}</div>
              )}
            </div>
          )}
